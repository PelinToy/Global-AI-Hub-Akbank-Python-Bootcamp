# -*- coding: utf-8 -*-
"""Akbank Python Bootcamp Final Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uo1bpLND5IryLY0UnoCGSTsVXcXIFSck
...
column_isim = ("İsim", "TC Kimlik Numarası", "Kredi Kartı Numarası", "Kredi Kartı Şifresi")  
 
with open("Menu.txt", "w") as menu:
  yazdirma_islem = csv.writer(menu)
  yazdirma_islem.writerow(["isim","TC Kimlik Numarası","Kredi Kartı Numarası","Kredi Kartı Şifresi"])
...
def main():
    ...
    with open('Orders_Database.csv', 'a') as orders:
        ...
        orders.writerow(["İsim","TC Kimlik Numarası","Kredi Kartı Numarası","Kredi Kartı Şifresi", "Acıklama", "Tarih"])
